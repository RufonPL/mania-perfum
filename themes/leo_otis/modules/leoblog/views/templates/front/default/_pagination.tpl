...
{if isset($p) AND $p}
	...
	<!-- Pagination -->
	<div class="product-count col-md-6 col-sm-6 col-xs-6 col-sp-12">
    	{if ($n*$p) < $nb_items }
	...
	<div id="pagination{if isset($paginationId)}_{$paginationId|escape:'html':'UTF-8'}{/if}" class="pagination col-md-6 col-sm-6 col-xs-6 col-sp-12 clearfix">
		{if $start!=$stop}
			<ul class="pagination">
			{if $p != 1}
