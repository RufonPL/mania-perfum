...
<div id="manufacturers_block_left" class="block blockmanufacturer">
	...
	<ul id="alphabet">
		<li><a href="#" id="all">Wszystko</a></li>
		<li><a href="#">A</a></li>
		<li><a href="#">B</a></li>
		<li><a href="#">C</a></li>
		<li><a href="#">D</a></li>
			...
			<ul class="list-block list-group bullet">
				{foreach from=$manufacturers item=manufacturer name=manufacturer_list}
					...
					<li class="{if $smarty.foreach.manufacturer_list.last}last_item{elseif $smarty.foreach.manufacturer_list.first}first_item{else}item{/if}">
						<a 
						href="{$link->getmanufacturerLink($manufacturer.id_manufacturer, $manufacturer.link_rewrite)|escape:'html':'UTF-8'}" title="{$manufacturer.name|escape:'html':'UTF-8'}">{$manufacturer.name|escape:'html':'UTF-8'}</a>
					</li>
					{/if}
				{/foreach}
			</ul>
