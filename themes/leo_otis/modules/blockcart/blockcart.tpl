...
<div class="blockcart_top clearfix{if $PS_CATALOG_MODE} header_user_catalog{/if}">
{/if}
	<div id="cart" class="shopping_cart">
			<a id="link_cart" href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
				<div class="meta-cart">
					<div class="img-cart">
						<i class="lm lm-icon-cart"></i>
					</div>
					<div class="name-cart">
						<div class="infor-cart">
							<span class="ajax_cart_quantity ">{if $cart_qties == 0 }0{else}{$cart_qties}{/if}</span>
							<span class="ajax_cart_product_txt_s {if $cart_qties <= 1}unvisible{/if}">{l s='items' mod='blockcart'} - </span>
							<span class="ajax_cart_product_txt {if $cart_qties > 1 || $cart_qties == 0 }unvisible{/if}">{l s='item' mod='blockcart'} - </span>
							<span class="cart-label">{l s='Cart' mod='blockcart'}</span>
				...
				<div class="block_content">
					...
					<div class="cart_block_list{if isset($blockcart_top) && !$blockcart_top}{if isset($colapseExpandStatus) && $colapseExpandStatus eq 'expanded' || !$ajax_allowed || !isset($colapseExpandStatus)} expanded{else} collapsed unvisible{/if}{/if}">
						...
						<div class="cart-prices">
							...
							<div class="cart-prices-line free_delivery_info"{if $free_delivery <= 0} style="display: none;"{/if}>
								<span class="price free_delivery_total" style="float:right">{$free_delivery_cost}</span>
	...
	<div id="layer_cart">
		<div class="clearfix">
			...
			<div class="layer_cart_cart col-xs-12 col-md-6">
				...
				<div class="layer_cart_row  free_delivery_info" {if $free_delivery <= 0} style="display: none;"{/if}>
					<strong class="dark">
