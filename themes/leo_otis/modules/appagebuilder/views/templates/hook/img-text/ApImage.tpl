...
<div id="image-{$formAtts.form_id|escape:'html':'UTF-8'}" class="block img-text {(isset($formAtts.css_class) && $formAtts.css_class) ? $formAtts.css_class : ''|escape:'html':'UTF-8'} {(isset($formAtts.class) && $formAtts.class) ? $formAtts.class : ''|escape:'html':'UTF-8'}">
	{($apLiveEdit)?$apLiveEdit:''}{* HTML form , no escape necessary *}

    {if isset($formAtts.title) && $formAtts.title}
        <h4 class="title_block 22">{$formAtts.title}{*contain html, no escape necessary*}</h4>
    {/if}
