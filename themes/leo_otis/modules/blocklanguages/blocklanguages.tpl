...
<!-- Block languages module -->
	<div class="popup-over language-block pull-left e-scale">
		<div class="popup-title" data-toggle="dropdown">
			<a href="#" title="{l s='Languages' mod='blocklanguages'}">
				<i class="fa fa-globe"></i>
				<span class="hidden">{l s='Languages : ' mod='blocklanguages'}</span>
				{foreach from=$languages key=k item=language name="languages"}
					{if $language.iso_code == $lang_iso}					 
						<span class="hidden-sp"><img src="{$img_lang_dir}{$language.id_lang}.jpg" alt="{$language.iso_code}" width="16" height="11" /></span>
					{/if}
				{/foreach}
			</a>
