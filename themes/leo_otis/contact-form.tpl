			...
			<div class="clearfix">
				...
				<div class="col-xs-12 col-md-8">
					<div class="form-group">
						...
						<textarea class="form-control" id="message" rows="10" name="message">{if isset($message)}{$message|escape:'html':'UTF-8'|stripslashes}{/if}</textarea>
					</div>
				</div>
			</div>
			<div class="submit">
...
<div style="float:left;font-size:20px;margin-left:20px"><p>Infolinia:</p>
<p><a href="tel:+48519690615">+48 519 690 615</a></p>
</div>

<div style="text-align:center;"><iframe src="https://maps.google.pl/maps?ie=UTF8&q=ul.+Ks.+W%C5%82adys%C5%82awa+%C5%BBaboklickiego+4%2F2+05-480&gl=PL&hl=pl&t=m&iwloc=A&output=embed"width="1270" height="350" frameborder="0"style="border:0"></iframe>
</div>