	...
	<div class="primary_block row">
		...
		<div class="pb-left-column col-xs-12 col-sm-12 col-md-5">
			...
			<div id="image-block" class="clearfix">
				...
				{if $have_image}
					<span id="view_full_size">
						{if $jqZoomEnabled && $have_image && !$content_only}
							<a class="jqzoom" title="" rel="gal1" href="{$link->getImageLink($product->link_rewrite, $cover.id_image, 'thickbox_default')|escape:'html':'UTF-8'}">
								<img class="img-responsive" itemprop="image" src="{$link->getImageLink($product->link_rewrite, $cover.id_image, 'large_default')|escape:'html':'UTF-8'}" title="" alt="{if !empty($cover.legend)}{$cover.legend|escape:'html':'UTF-8'}{else}{$product->name|escape:'html':'UTF-8'}{/if}"/>
							</a>
						{else}
							<img id="bigpic" class="img-responsive" itemprop="image" src="{$link->getImageLink($product->link_rewrite, $cover.id_image, 'large_default')|escape:'html':'UTF-8'}" title="" alt="{if !empty($cover.legend)}{$cover.legend|escape:'html':'UTF-8'}{else}{$product->name|escape:'html':'UTF-8'}{/if}"/>
							{if !$content_only}
				...
				{else}
					<span id="view_full_size">
						<img itemprop="image" src="{$img_prod_dir}{$lang_iso}-default-large_default.jpg" id="bigpic" alt="" title=""/>
						{if !$content_only}
							...
							{foreach from=$images item=image name=thumbnails}
								...
								<li id="thumbnail_{$image.id_image}"{if $smarty.foreach.thumbnails.last} class="last"{/if}>
									<a{if $jqZoomEnabled && $have_image && !$content_only} href="javascript:void(0);" rel="{literal}{{/literal}gallery: 'gal1', smallimage: '{$link->getImageLink($product->link_rewrite, $imageIds, 'large_default')|escape:'html':'UTF-8'}',largeimage: '{$link->getImageLink($product->link_rewrite, $imageIds, 'thickbox_default')|escape:'html':'UTF-8'}'{literal}}{/literal}"{else} href="{$link->getImageLink($product->link_rewrite, $imageIds, 'thickbox_default')|escape:'html':'UTF-8'}"	data-fancybox-group="other-views" class="fancybox{if $image.id_image == $cover.id_image} shown{/if}"{/if} title="">
										<img class="img-responsive" id="thumb_{$image.id_image}" src="{$link->getImageLink($product->link_rewrite, $imageIds, 'cart_default')|escape:'html':'UTF-8'}" alt="{$imageTitle}" title="" itemprop="image" />
									</a>
								</li>
							{/foreach}
						{/if}
		...
		{hook h="displayPytanie"}
		<!--
		<a class="pytanie" href="{$this_path}productquestion-form.php?id_product={$smarty.get.id_product|intval}"><i class="fa fa-question-circle" aria-hidden="true"></i> Zadaj pytaniee</a>
		-->
					...
					<div class="box-info-product">
						...
						<div class="box-cart-bottom">
							<div{if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || (isset($restricted_country_mode) && $restricted_country_mode) || $PS_CATALOG_MODE} class="unvisible"{/if}>
								<p id="add_to_cart" class="buttons_bottom_block no-print" title="{l s='Add to cart'}">
									<button type="submit" name="Submit" class="exclusive btn btn-outline">
										<i class="fa fa-shopping-cart"></i><span>{if $content_only && (isset($product->customization_required) && $product->customization_required)}{l s='Customize'}{else}{l s='Add to cart'}{/if}</span>
									</button>
								</p>
							</div>
							...
							{if isset($comparator_max_item) && $comparator_max_item}
								<p id="add_to_compare">
									<a class="add_to_compare btn-product" href="{$link->getPageLink('products-comparison')|escape:'html':'UTF-8'}" data-id-product="{$product->id|intval}" title="{l s='Add to Compare'}">
										<i class="fa fa-reply-all"></i> <span>{l s='Add to Compare'}</span>
									</a>
								</p>
							{/if}
							<div>
								<div class="ss_przycisk" title="Zamów przez telefon">
									<a href="tel:+48519690615" style="color:#fff;font-size:16px">
										<div style="float:left; margin-left:25px; margin-top:7px"><i class="lm lm-icon-phone"></i></div><div style="margin:0;float:left">Zamów przez telefon</div>
									</a>
								</div>
							</div>
