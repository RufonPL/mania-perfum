...
$(document).ready(function(){
	...
	//DONGND:: hide slidebar menu when scrolldown
	$(window).scroll(function(){
		...
		if($(window).scrollTop()>0 && $('body').hasClass('keep-header'))
		{
			if($('.leo-verticalmenu').hasClass('active') && !$('.leo-verticalmenu').hasClass('first-scroll'))
			{
				...
				$('.leo-verticalmenu').addClass('first-scroll');
			}
		...
		if($(window).scrollTop() == 0 && $('body').hasClass('keep-header'))
		{
			$('.leo-verticalmenu').addClass('active');
			$('.leo-verticalmenu').removeClass('first-scroll');
		}
	})
});
...
$(document).ready(function(){
	$('.sidebar .title_block,.blockproductscategory .productscategory_h3,.blogs-container .title_block,#center_column .ApColumn .title_block').each(function(){
	...
	$('.sidebar .title_block a').each(function(){
...
$(function(){
    $('#click_show_search').click(function(e) {
    	e.stopPropagation();
        if($('#leosearchtopbox').hasClass('showsearch')){
            $('#leosearchtopbox').removeClass('showsearch');
        }
        else{
            $('#leosearchtopbox').addClass('showsearch');
        }
    });
    $('#leosearchtopbox').click(function(e) {
    	e.stopPropagation();
    });
    $('#page').click(function() {
		if($('#leosearchtopbox').hasClass('showsearch')){
