			...
			<div class="product_list grid row">
				{foreach from=$accessories item=accessory name=accessories_list}
					{if ($accessory.allow_oosp || $accessory.quantity_all_versions > 0 || $accessory.quantity > 0) && $accessory.available_for_order && !isset($restricted_country_mode)}
						...
						<div class="product_block col-sp-12 col-xs-6 col-sm-6 col-md-3 col-lg-3 item ajax_block_product{if $smarty.foreach.accessories_list.first} first_item{elseif $smarty.foreach.accessories_list.last} last_item{else} item{/if} product_accessories_description">
							<div class="product-container product-block" itemscope itemtype="https://schema.org/Product">
								<div class="left-block">
									...
									<div class="group-label">
										{if (!$PS_CATALOG_MODE AND ((isset($accessory.show_price) && $accessory.show_price) || (isset($accessory.available_for_order) && $accessory.available_for_order)))}
											{if isset($accessory.show_price) && $accessory.show_price && !isset($restricted_country_mode)}
												{if $accessory.price_without_reduction > 0 && isset($accessory.specific_prices) && $accessory.specific_prices && isset($accessory.specific_prices.reduction) && $accessory.specific_prices.reduction > 0}
													{if $accessory.specific_prices.reduction_type == 'percentage'}
														<div class="price-percent-reduction-box label-price-percent-reduction label">
															<span class="price-percent-reduction product-label">-{$accessory.specific_prices.reduction * 100}%</span>
														</div>
													{/if}
												{/if}
											{/if}
										...
										{if isset($accessory.new) && $accessory.new == 1}
											<a class="new-box label label-new" href="{$accessory.link|escape:'html':'UTF-8'}">
										...
										{if isset($accessory.on_sale) && $accessory.on_sale && isset($accessory.show_price) && $accessory.show_price && !$PS_CATALOG_MODE}
											<a class="sale-box label label-sale" href="{$accessory.link|escape:'html':'UTF-8'}">
									...
									{if isset($quick_view) && $quick_view}
										<div class="quickview">
											<a class="quick-view btn-tooltip btn-product" href="{$accessory.link|escape:'html':'UTF-8'}" rel="{$accessory.link|escape:'html':'UTF-8'}" data-original-title="{l s='Quick view'}">
									...
									<div class="functional-buttons clearfix">
										{if isset($comparator_max_item) && $comparator_max_item}
											<div class="compare">
												<a class="add_to_compare btn-product" href="{$accessory.link|escape:'html':'UTF-8'}" data-id-product="{$accessory.id_product}">
								...
								<div class="right-block">			
									<div class="product-meta">
										<h5 class="name" itemprop="name">
											<a href="{$accessoryLink|escape:'html':'UTF-8'}" class="product-name">
										...
										<div class="functional-buttons clearfix">
											{if (!$PS_CATALOG_MODE AND ((isset($accessory.show_price) && $accessory.show_price) || (isset($accessory.available_for_order) && $accessory.available_for_order)))}
												<div class="content_price">
													{if isset($accessory.show_price) && $accessory.show_price && !isset($restricted_country_mode)}
														{hook h="displayProductPriceBlock" product=$accessory type='before_price'}
														<span class="price product-price {if $accessory.price_without_reduction > 0 && isset($accessory.specific_prices) && $accessory.specific_prices && isset($accessory.specific_prices.reduction) && $accessory.specific_prices.reduction > 0}has-old-price{/if}">
